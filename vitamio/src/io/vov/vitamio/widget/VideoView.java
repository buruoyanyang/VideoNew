...
public class VideoView extends SurfaceView implements MediaController.MediaPlayerControl {
    ...
    public boolean gotoFullScreen = false;
    ...
    /****************/
    private MediaPlayer.OnFullScreenChangeListener mFullScreenChangeListener = new MediaPlayer.OnFullScreenChangeListener() {
        @Override
    ...
    private void openVideo() {
        ...
        try {
            ...
            mMediaPlayer.setOnFullScreenChangeListener(mFullScreenChangeListener);
...
//        mMediaController.setFileName(name);
    ...
    public void setOnFullScreenboolChangeListener(MediaPlayer.OnFullScreenChangeListener l)
    {
    ...
    public void fullScreen() {
        mMediaPlayer.changeFUllScreenBoolen();
